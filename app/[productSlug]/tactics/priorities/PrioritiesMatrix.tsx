...
const PrioritiesMatrix: FC<PrioritiesMatrixProps> = ({children}) => {
	return (
		<div className="relative h-full">
			<div className="relative h-full w-0 text-[0.6rem] text-laurel">
				<UpOutlined className="absolute top-[-2px] -translate-x-1/2" />
				<div className="h-full w-px -translate-x-1/2 bg-laurel" />
			...
			<div className="relative h-0 w-full text-[0.6rem] text-laurel">
				<RightOutlined className="absolute right-[-2px] -translate-y-1/2" />
				<div className="h-px w-full -translate-y-1/2 bg-laurel" />
			...
			<div className="absolute left-1/2 top-0 h-full border-r border-dashed border-laurel" />
			<div className="absolute left-0 top-1/2 w-full border-t border-dashed border-laurel" />
