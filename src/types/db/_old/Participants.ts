...
export const OldParticipantSchema = z.object({
...
export type Participant = z.infer<typeof OldParticipantSchema>
export const ParticipantConverter = genConverter(OldParticipantSchema)
