...
const Account = () => {
	...
	return (
		<Row gutter={62}>
			...
			<Col span={4}>
				<h3 className="mb-2 w-16 text-center text-[16px] font-semibold">Avatar</h3>
				<Avatar className="flex items-center justify-center" src={user?.photoURL} size={64} icon={<UserOutlined />} />
				<p className="w-16 text-center text-[#1890FF]">Edit</p>
			</Col>
		</Row>
	)
}
