...
) =>
{
    ...
    return (
        <div
            ...
            <div style={ { height: "112%", transform: "translateY(-5%)" } } className="absolute w-2/3 flex flex-col items-center justify-between right-0">

                <p className='font-[600] text-[#A6AE9D] text-[14px] leading-[22px]'>Start</p>
