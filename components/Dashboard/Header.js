...
const AppHeader = () => {
	...
	return (
		<CustomHeader className="header" style={{position: "fixed", zIndex: 1000000, width: "100%"}}>
			<div className="flex items-center">
				<Image src="/images/logo_beta.png" alt="Logo" className="h-[42px] w-[178px]" preview={false} />
        ...
        /> */}
			...
			<Drawer
				id="settingsDrawer"
				title={<span className="text-[16px] font-semibold">Settings</span>}
				placement="right"
				...
				extra={
					<Space>
						<div className="flex h-full items-center">
							<CloseOutlined style={{width: "10px", height: "10px"}} onClick={() => setSettingsMenuDrawer(false)} />
						</div>
					</Space>
				}
			>
