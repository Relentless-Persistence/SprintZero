        ...
        <MyCard
            ...
            <section>
                            ...
                            <ul>
                                {
                                    comment.data?.blockers.map( ( d, i ) => (
                                        !( i == comment.data?.blockers.length - 1 && showAddNews.blockers ) ? <li key={ i }>
                ...
                <div className="section">
                    ...
                    {
                        comment.data?.today?.length ? ( <ul>
                            {
                                comment.data?.today?.map( ( d, i ) => (
                                    !( i == comment.data?.today.length - 1 && showAddNews.today ) ? <li key={ i }>
                            ...
                            <ul>
                                {
                                    comment.data?.yesterday?.map( ( d, i ) => (
                                        !( i == comment.data?.yesterday.length - 1 && showAddNews.yesterday ) ? <li key={ i }>
