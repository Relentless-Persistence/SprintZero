...
interface Uint8ClampedArray {
	 ...
	 */
	findLast<S extends number>(
		predicate: (value: number, index: number, array: Uint8ClampedArray) => value is S,
		thisArg?: any,
	): S | undefined
	findLast(
...
interface Float64Array {
	 ...
	 */
	findLast<S extends number>(
		predicate: (value: number, index: number, array: Float64Array) => value is S,
		thisArg?: any,
	): S | undefined
...
interface BigInt64Array {
	...
	findLast<S extends bigint>(
		predicate: (value: bigint, index: number, array: BigInt64Array) => value is S,
		thisArg?: any,
	): S | undefined
	findLast(
...
interface BigUint64Array {
	 ...
	 */
	findLast<S extends bigint>(
		predicate: (value: bigint, index: number, array: BigUint64Array) => value is S,
		thisArg?: any,
	): S | undefined
	findLast(
